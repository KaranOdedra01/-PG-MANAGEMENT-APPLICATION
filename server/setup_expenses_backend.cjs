...
const expenseModel = `import mongoose from 'mongoose';
...
const expenseController = `import mongoose from 'mongoose';
...
const expenseRoutes = `import express from 'express';
import {
  getExpenses,
  getExpenseSummary,
  createExpense,
...
fs.writeFileSync(path.join(__dirname, 'src/models/Expense.js'), expenseModel, 'utf8');
fs.writeFileSync(path.join(__dirname, 'src/controllers/expenseController.js'), expenseController, 'utf8');
fs.writeFileSync(path.join(__dirname, 'src/routes/expenseRoutes.js'), expenseRoutes, 'utf8');
console.log('Successfully generated Expense backend files!');
