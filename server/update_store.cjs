...
// 1. Enrich inMemoryStore with realistic data for rooms, invoices, complaints, notices, expenses
const inMemoryStoreCode = `import bcrypt from 'bcryptjs';
...
fs.writeFileSync(path.join(__dirname, 'src/utils/inMemoryStore.js'), inMemoryStoreCode, 'utf8');
console.log('Updated inMemoryStore with rich sample data.');
