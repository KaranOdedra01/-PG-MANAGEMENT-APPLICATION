...
const noticeModel = `import mongoose from 'mongoose';
...
const noticeController = `import mongoose from 'mongoose';
...
const noticeRoutes = `import express from 'express';
import {
  getNotices,
  getNoticeById,
  createNotice,
...
fs.writeFileSync(path.join(__dirname, 'src/models/Notice.js'), noticeModel, 'utf8');
fs.writeFileSync(path.join(__dirname, 'src/controllers/noticeController.js'), noticeController, 'utf8');
fs.writeFileSync(path.join(__dirname, 'src/routes/noticeRoutes.js'), noticeRoutes, 'utf8');
console.log('Successfully generated Notice Board backend files!');
