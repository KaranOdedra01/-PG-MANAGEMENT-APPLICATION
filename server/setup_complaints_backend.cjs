...
const complaintController = `import mongoose from 'mongoose';
...
const complaintRoutes = `import express from 'express';
import {
  getComplaints,
  getComplaintById,
  createComplaint,
...
fs.writeFileSync(path.join(__dirname, 'src/controllers/complaintController.js'), complaintController, 'utf8');
fs.writeFileSync(path.join(__dirname, 'src/routes/complaintRoutes.js'), complaintRoutes, 'utf8');
console.log('Successfully generated Complaint backend files!');
