...
const invoiceController = `import mongoose from 'mongoose';
...
const invoiceRoutes = `import express from 'express';
import {
  getInvoices,
  getInvoiceById,
  createInvoice,
...
fs.writeFileSync(path.join(__dirname, 'src/controllers/invoiceController.js'), invoiceController, 'utf8');
fs.writeFileSync(path.join(__dirname, 'src/routes/invoiceRoutes.js'), invoiceRoutes, 'utf8');
console.log('Successfully generated Invoice backend files!');
